...
export async function getQuestionsForPost(postId: string) {
  console.log("Getting questions for post:", postId);
  ...
  try {
    ...
    if (error) {
      console.error("Error fetching questions for post:", error);
      throw error;
    }
    
    return data;
  } catch (error) {
    console.error("Exception in getQuestionsForPost:", error);
    throw error;
  }
}
...
export async function createQuestion(postId: string, content: string) {
  try {
    ...
    console.error("Exception in createQuestion:", error);
    throw error;
  }
}
